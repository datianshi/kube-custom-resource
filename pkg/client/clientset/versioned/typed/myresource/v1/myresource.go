...
import (
	...
	scheme "github.com/datianshi/kube-custom-resource/pkg/client/clientset/versioned/scheme"
...
func newMyResources(c *DatianshiV1Client, namespace string) *myResources {
	return &myResources{
		client: c.RESTClient(),
		ns:     namespace,
	}
